export const CommonWordList = [
  ...
  {
    word: `of`,
    wordInfo: [`Expressing distance or motion.`, `To possess, own.`],
  },
  {
    word: `a`,
    wordInfo: [
  ...
  { word: `too`, wordInfo: [`(focus) Likewise.`] },
  {
    word: `it`,
    wordInfo: [
  ...
  },
  {
    ...
    wordInfo: [
      ...
      `A syllable used in solf�ge to represent the first and eighth tonic of a major scale.`,
  ...
  { word: `from`, wordInfo: [`Used to indicate source or provenance.`] },
  {
    word: `that`,
    wordInfo: [
      `Something being indicated that is there; one of those.`,
  ...
  {
    word: `get`,
    wordInfo: [`Offspring.`, `A git.`, `(ditransitive) To obtain; to acquire.`],
  },
  {
    word: `if`,
    wordInfo: [
  ...
  { word: `my`, wordInfo: [`Used to express surprise, shock or amazement.`] },
  {
    word: `make`,
    wordInfo: [
      `Brand or kind; model.`,
  ...
  {
    word: `about`,
    wordInfo: [`Moving around; astir.`, `On all sides; around.`],
  },
  {
    word: `know`,
    wordInfo: [
  ...
  { word: `them`, wordInfo: [`(plural) Those ones.`] },
  {
    word: `some`,
    wordInfo: [
  ...
  { word: `me`, wordInfo: [`As the direct object of a verb.`] },
  {
    word: `people`,
    wordInfo: [
  ...
  { word: `into`, wordInfo: [`To or towards the inside of.`] },
  {
    word: `just`,
    wordInfo: [
  ...
  { word: `now`, wordInfo: [`The present time.`, `Present; current.`] },
  {
    word: `than`,
    wordInfo: [
      `At that time; then.`,
  ...
  { word: `these`, wordInfo: [`The thing, item, etc. being indicated.`] },
  {
    word: `want`,
    wordInfo: [
  ...
  },
  {
    ...
    wordInfo: [
      ...
      `To travel.`,
      `(with comparative or modified adjective) Much.`,
    ],
  },
  {
    word: `first`,
  ...
  {
    word: `also`,
    wordInfo: [`(focus) In addition; besides; as well; further; too.`],
  },
  {
    word: `new`,
    wordInfo: [`Things that are new.`, `To make new; to recreate; to renew.`],
  },
  {
    word: `because`,
    wordInfo: [`For the reason (that).`, `On account of, because of.`],
  },
  {
    word: `day`,
    wordInfo: [`Any period of 24 hours.`, `To spend a day (in a place).`],
  },
  {
    word: `more`,
    wordInfo: [
  ...
  { word: `use`, wordInfo: [`The act of using.`, `To utilize or employ.`] },
  {
    word: `no`,
    wordInfo: [
  ...
  { word: `only`, wordInfo: [`An only child.`, `Alone in a category.`] },
  {
    word: `those`,
    wordInfo: [
  ...
  {
    word: `very`,
    wordInfo: [`True, real, actual.`, `To a great extent or degree.`],
  },
  {
    word: `her`,
    wordInfo: [
  ...
  {
    word: `woman`,
    wordInfo: [`An adult female human.`, `To staff with female labor.`],
  },
  {
    word: `through`,
    wordInfo: [
  ...
  {
    word: `call`,
    wordInfo: [`A telephone conversation.`, `(heading) To use one's voice.`],
  },
  {
    word: `world`,
    wordInfo: [
  ...
  {
    word: `never`,
    wordInfo: [`At no time; on no occasion; in no circumstance.`],
  },
  { word: `become`, wordInfo: [`To arrive, come (to a place).`] },
  {
    word: `between`,
    wordInfo: [
  ...
  { word: `another`, wordInfo: [`An additional one of the same kind.`] },
  { word: `much`, wordInfo: [`Large, great.`, `To a great extent.`] },
  {
    word: `family`,
    wordInfo: [
  ...
  { word: `mean`, wordInfo: [`To lament.`, `Common; general.`, `To intend.`] },
  {
    word: `on`,
    wordInfo: [
      `To switch on`,
  ...
  {
    word: `student`,
    wordInfo: [`A person who studies or learns about a particular subject.`],
  },
  {
    word: `why`,
    wordInfo: [
  ...
  {
    word: `seem`,
    wordInfo: [`To appear; to look outwardly; to be perceived as.`],
  },
  {
    word: `country`,
    wordInfo: [
  ...
  {
    word: `part`,
    wordInfo: [`A portion; a component.`, `To leave the company of.`],
  },
  {
    word: `about`,
    wordInfo: [`Moving around; astir.`, `On all sides; around.`],
  ...
  {
    word: `again`,
    wordInfo: [`Another time; once more.`, `(obsolete or dialectal) Against.`],
  },
  { word: `few`, wordInfo: [`Few people, few things.`] },
  {
    word: `case`,
    wordInfo: [
  ...
  { word: `week`, wordInfo: [`Any period of seven consecutive days.`] },
  {
    word: `company`,
    wordInfo: [
  ...
  { word: `right`, wordInfo: [`Straight, not bent.`, `On the right side.`] },
  {
    word: `program`,
    wordInfo: [
  ...
  { word: `hear`, wordInfo: [`(stative) To perceive sounds through the ear.`] },
  {
    word: `so`,
    wordInfo: [
      `True, accurate.`,
  ...
  {
    word: `always`,
    wordInfo: [`At all times; throughout all time; since the beginning.`],
  },
  {
    word: `move`,
    wordInfo: [
  ...
  { word: `live`, wordInfo: [`To be alive; to have life.`, `Life`] },
  {
    word: `point`,
    wordInfo: [
  ...
  {
    word: `today`,
    wordInfo: [`A current day or date.`, `On the current day or date.`],
  },
  {
    word: `bring`,
    wordInfo: [
  ...
  { word: `happen`, wordInfo: [`To occur or take place.`, `Maybe, perhaps.`] },
  {
    word: `next`,
    wordInfo: [
  ...
  {
    word: `before`,
    wordInfo: [`At an earlier time.`, `Earlier than (in time).`],
  },
  {
    word: `large`,
    wordInfo: [
  ...
  {
    word: `home`,
    wordInfo: [`A dwelling.`, `(of animals) To return to its owner.`],
  },
  {
    word: `under`,
    wordInfo: [
  ...
  {
    word: `national`,
    wordInfo: [`A subject of a nation.`, `Of or having to do with a nation.`],
  },
  {
    word: `money`,
    wordInfo: [
  ...
  {
    word: `job`,
    wordInfo: [`A task.`, `To do odd jobs or occasional work for hire.`],
  },
  {
    word: `word`,
    wordInfo: [
  ...
  {
    word: `though`,
    wordInfo: [`Despite that; however.`, `Despite the fact that; although.`],
  },
  {
    word: `business`,
    wordInfo: [
  ...
  { word: `little`, wordInfo: [`A small amount.`, `Small in size.`] },
  {
    word: `house`,
    wordInfo: [
  ...
  {
    word: `provide`,
    wordInfo: [`To make a living; earn money for necessities.`],
  },
  {
    word: `service`,
    wordInfo: [
  ...
  { word: `important`, wordInfo: [`Having relevant and crucial value.`] },
  {
    word: `father`,
    wordInfo: [
  ...
  {
    word: `hour`,
    wordInfo: [`A time period of sixty minutes; one twenty-fourth of a day.`],
  },
  {
    word: `game`,
    wordInfo: [`A playful or competitive activity.`, `To gamble.`],
  },
  { word: `often`, wordInfo: [`Frequent.`, `Frequently, many times.`] },
  {
    word: `yet`,
    wordInfo: [
  ...
  },
  {
    ...
    wordInfo: [
      ...
      `(obsolete outside dialectal) To remember.`,
    ],
  },
  {
    word: `pay`,
  ...
  {
    word: `body`,
    wordInfo: [`Physical frame.`, `To give body or shape to something.`],
  },
  {
    word: `information`,
    wordInfo: [
  ...
  {
    word: `ago`,
    wordInfo: [`Gone; gone by; gone away; passed; passed away.`, `Before`],
  },
  { word: `right`, wordInfo: [`Straight, not bent.`, `On the right side.`] },
  {
    word: `lead`,
  ...
  {
    word: `history`,
    wordInfo: [`The aggregate of past events.`, `To narrate or record.`],
  },
  {
    word: `party`,
    wordInfo: [
  ...
  { word: `grow`, wordInfo: [`To become larger, to increase in magnitude.`] },
  {
    word: `result`,
    wordInfo: [
  ...
  { word: `win`, wordInfo: [`To conquer, defeat.`, `An individual victory.`] },
  {
    word: `research`,
    wordInfo: [
  ...
  { word: `moment`, wordInfo: [`A brief, unspecified amount of time.`] },
  {
    word: `himself`,
    wordInfo: [
  ...
  {
    word: `teacher`,
    wordInfo: [`A person who teaches, especially one employed in a school.`],
  },
  {
    word: `force`,
    wordInfo: [
  ...
  {
    word: `education`,
    wordInfo: [`The process of imparting knowledge, skill and judgment.`],
  },
  {
    word: `across`,
    wordInfo: [
  ...
  {
    word: `boy`,
    wordInfo: [`A young male.`, `To use the word �boy� to refer to someone.`],
  },
  {
    word: `maybe`,
    wordInfo: [`Something that is possibly true.`, `Possible; uncertain.`],
  },
  {
    word: `toward`,
    wordInfo: [
  ...
  { word: `able`, wordInfo: [`Easy to use.`, `To make ready.`] },
  {
    word: `age`,
    wordInfo: [
  ...
  { word: `everything`, wordInfo: [`All the things under discussion.`] },
  {
    word: `love`,
    wordInfo: [
      `Strong affection.`,
  ...
  { word: `consider`, wordInfo: [`To think about seriously.`] },
  {
    word: `appear`,
    wordInfo: [`To come or be in sight; to be in view; to become visible.`],
  },
  {
    word: `actually`,
    wordInfo: [`(modal) In act or in fact; really; in truth; positively.`],
  },
  {
    word: `buy`,
    wordInfo: [
  ...
  { word: `probably`, wordInfo: [`In all likelihood.`] },
  {
    word: `human`,
    wordInfo: [
  ...
  {
    word: `expect`,
    wordInfo: [`To predict or believe that something will happen`],
  },
  {
    word: `home`,
    wordInfo: [`A dwelling.`, `(of animals) To return to its owner.`],
  ...
  { word: `college`, wordInfo: [`A corporate group; a group of colleagues.`] },
  {
    word: `interest`,
    wordInfo: [
  ...
  {
    word: `someone`,
    wordInfo: [`A partially specified but unnamed person.`, `Some person.`],
  },
  {
    word: `experience`,
    wordInfo: [
  ...
  {
    word: `behind`,
    wordInfo: [`The rear, back-end`, `At the back part; in the rear.`],
  },
  {
    word: `reach`,
    wordInfo: [
  ...
  {
    word: `suggest`,
    wordInfo: [`To imply but stop short of saying explicitly.`],
  },
  {
    word: `class`,
    wordInfo: [
  ...
  {
    word: `require`,
    wordInfo: [`To ask (someone) for something; to request.`],
  },
  {
    word: `along`,
    wordInfo: [
  ...
  {
    word: `development`,
    wordInfo: [`The process of developing; growth, directed change.`],
  },
  {
    word: `themselves`,
    wordInfo: [
  ...
  { word: `economic`, wordInfo: [`Pertaining to an economy.`] },
  {
    word: `effort`,
    wordInfo: [
  ...
  { word: `leader`, wordInfo: [`Any person that leads or directs`] },
  {
    word: `light`,
    wordInfo: [
  ...
  { word: `finally`, wordInfo: [`At the end or conclusion; ultimately.`] },
  {
    word: `pull`,
    wordInfo: [
  ...
  {
    word: `free`,
    wordInfo: [`Free transfer`, `To make free; set at liberty; release.`],
  },
  {
    word: `military`,
    wordInfo: [
  ...
  {
    word: `develop`,
    wordInfo: [`To change with a specific direction, progress.`],
  },
  { word: `view`, wordInfo: [`(physical) Visual perception.`, `To look at.`] },
  {
    word: `relationship`,
    wordInfo: [`Connection or association; the condition of being related.`],
  },
  {
    word: `carry`,
    wordInfo: [
  ...
  {
    word: `true`,
    wordInfo: [`The state of being in alignment.`, `To straighten.`],
  },
  {
    word: `federal`,
    wordInfo: [
  ...
  {
    word: `position`,
    wordInfo: [`A place or location.`, `To put into place.`],
  },
  { word: `player`, wordInfo: [`One that plays`] },
  {
    word: `agree`,
    wordInfo: [
  ...
  {
    word: `especially`,
    wordInfo: [`(manner) In a special manner; specially.`],
  },
  {
    word: `record`,
    wordInfo: [
  ...
  { word: `space`, wordInfo: [`(heading) Of time.`, `To roam, walk, wander.`] },
  {
    word: `ground`,
    wordInfo: [
  ...
  {
    word: `whose`,
    wordInfo: [`(interrogative) That or those of whom or belonging to whom.`],
  },
  { word: `matter`, wordInfo: [`Substance, material.`, `To be important.`] },
  { word: `everyone`, wordInfo: [`Every person.`] },
  {
    word: `center`,
    wordInfo: [
  ...
  {
    word: `activity`,
    wordInfo: [`The state or quality of being active; activeness.`],
  },
  {
    word: `star`,
    wordInfo: [
  ...
  },
  {
    ...
    wordInfo: [
      ...
      `(usually as a term of address) teacher`,
    ],
  },
  { word: `oil`, wordInfo: [`Liquid fat.`, `To lubricate with oil.`] },
  {
    word: `half`,
    wordInfo: [
  ...
  {
    word: `easy`,
    wordInfo: [`Something that is easy`, `Comfortable; at ease.`],
  },
  {
    word: `cost`,
    wordInfo: [
  ...
  {
    word: `industry`,
    wordInfo: [`The tendency to work persistently. Diligence.`],
  },
  {
    word: `figure`,
    wordInfo: [
  ...
  { word: `recent`, wordInfo: [`Having happened a short while ago.`] },
  { word: `describe`, wordInfo: [`To represent in words.`] },
  {
    word: `product`,
    wordInfo: [`A commodity offered for sale.`, `To produce.`],
  },
  {
    word: `doctor`,
    wordInfo: [
  ...
  {
    word: `news`,
    wordInfo: [`New information of interest.`, `To report; to make known.`],
  },
  {
    word: `test`,
    wordInfo: [
  ...
  {
    word: `technology`,
    wordInfo: [`The organization of knowledge for practical purposes.`],
  },
  {
    word: `catch`,
    wordInfo: [
  ...
  {
    word: `computer`,
    wordInfo: [`A person employed to perform computations; one who computes.`],
  },
  {
    word: `type`,
    wordInfo: [
  ...
  { word: `nearly`, wordInfo: [`With great scrutiny; carefully.`] },
  { word: `organization`, wordInfo: [`The quality of being organized.`] },
  {
    word: `choose`,
    wordInfo: [
  ...
  {
    word: `energy`,
    wordInfo: [`The impetus behind all motion and all activity.`],
  },
  {
    word: `period`,
    wordInfo: [`A length of time.`, `To come to a period; to conclude.`],
  },
  {
    word: `course`,
    wordInfo: [
  ...
  {
    word: `opportunity`,
    wordInfo: [`A chance for advancement, progress or profit.`],
  },
  {
    word: `term`,
    wordInfo: [
  ...
  {
    word: `short`,
    wordInfo: [`A short circuit.`, `To cause a short circuit in (something).`],
  },
  {
    word: `letter`,
    wordInfo: [
  ...
  { word: `daughter`, wordInfo: [`One�s female offspring.`] },
  {
    word: `administration`,
    wordInfo: [
  ...
  {
    word: `thousand`,
    wordInfo: [`A numerical value equal to 1,000 = 10 � 100 = 103`],
  },
  {
    word: `risk`,
    wordInfo: [
  ...
  {
    word: `involve`,
    wordInfo: [`To roll or fold up; to wind round; to entwine.`],
  },
  {
    word: `defense`,
    wordInfo: [
  ...
  { word: `anyone`, wordInfo: [`Any person; anybody.`] },
  {
    word: `increase`,
    wordInfo: [
  ...
  {
    word: `certainly`,
    wordInfo: [`In a way which is certain; with certainty.`],
  },
  {
    word: `west`,
    wordInfo: [
  ...
  { word: `behavior`, wordInfo: [`Human conduct relative to social norms.`] },
  {
    word: `deal`,
    wordInfo: [
  ...
  { word: `quickly`, wordInfo: [`Rapidly; with speed; fast.`] },
  {
    word: `past`,
    wordInfo: [
      `To change place.`,
  ...
  { word: `recently`, wordInfo: [`In the recent past`] },
  {
    word: `store`,
    wordInfo: [
  ...
  { word: `movement`, wordInfo: [`Physical motion between points in space.`] },
  {
    word: `page`,
    wordInfo: [
  ...
  {
    word: `decade`,
    wordInfo: [`A group, set, or series of ten , particularly:`],
  },
  {
    word: `article`,
    wordInfo: [
  ...
  { word: `artist`, wordInfo: [`A person who creates art.`, `Artistic.`] },
  {
    word: `away`,
    wordInfo: [
      `To depart; to go to another place.`,
  ...
  { word: `central`, wordInfo: [`Being in the centre.`] },
  {
    word: `eight`,
    wordInfo: [
      `The digit/figure 8.`,
  ...
  },
  {
    ...
    wordInfo: [
      ...
      `Frankincense obtained from conifers such as the Norway spruce, or long-leaved pine.`,
    ],
  },
  {
    word: `treatment`,
    wordInfo: [`The process or manner of treating someone or something.`],
  },
  { word: `beyond`, wordInfo: [`The unknown.`, `Farther along or away.`] },
  {
    word: `happy`,
    wordInfo: [
  ...
  {
    word: `protect`,
    wordInfo: [`To keep safe; to defend; to guard; to prevent harm coming to.`],
  },
  {
    word: `approach`,
    wordInfo: [
  ...
  { word: `fund`, wordInfo: [`A sum or source of money.`, `To pay for.`] },
  {
    word: `serious`,
    wordInfo: [
  ...
  { word: `occur`, wordInfo: [`To happen or take place.`] },
  {
    word: `media`,
    wordInfo: [
  ...
  {
    word: `ready`,
    wordInfo: [`Ready money; cash`, `To prepare; to make ready for action.`],
  },
  {
    word: `sign`,
    wordInfo: [
  ...
  {
    word: `thought`,
    wordInfo: [`To ponder, to go over in one's head.`, `To seem, to appear.`],
  },
  {
    word: `list`,
    wordInfo: [
  ...
  {
    word: `identify`,
    wordInfo: [`To establish the identity of someone or something.`],
  },
  {
    word: `left`,
    wordInfo: [
  ...
  { word: `determine`, wordInfo: [`To set the boundaries or limits of.`] },
  {
    word: `prepare`,
    wordInfo: [
      `Preparation`,
  ...
  { word: `success`, wordInfo: [`The achievement of one's aim or goal.`] },
  {
    word: `argue`,
    wordInfo: [`To show grounds for concluding (that); to indicate, imply.`],
  },
  {
    word: `cup`,
    wordInfo: [
  ...
  { word: `particularly`, wordInfo: [`(focus) Especially, extremely.`] },
  {
    word: `amount`,
    wordInfo: [
  ...
  { word: `ability`, wordInfo: [`Suitableness.`] },
  {
    word: `staff`,
    wordInfo: [
  ...
  {
    word: `growth`,
    wordInfo: [`An increase in size, number, value, or strength.`],
  },
  {
    word: `loss`,
    wordInfo: [
  ...
  {
    word: `training`,
    wordInfo: [`To practice an ability.`, `Action of the verb to train.`],
  },
  {
    word: `pretty`,
    wordInfo: [
  ...
  { word: `everybody`, wordInfo: [`All people.`] },
  { word: `physical`, wordInfo: [`Physical examination.`, `Of medicine.`] },
  {
    word: `lay`,
    wordInfo: [
  ...
  { word: `arrive`, wordInfo: [`To reach; to get to a certain place.`] },
  {
    word: `analysis`,
    wordInfo: [
  ...
  { word: `environmental`, wordInfo: [`Pertaining to the environment.`] },
  {
    word: `glass`,
    wordInfo: [
  ...
  {
    word: `operation`,
    wordInfo: [`The method by which a device performs its function.`],
  },
  { word: `financial`, wordInfo: [`Related to finances.`] },
  {
    word: `crime`,
    wordInfo: [
  ...
  {
    word: `stage`,
    wordInfo: [`A phase.`, `To produce on a stage, to perform a play.`],
  },
  { word: `ok`, wordInfo: [`All right, permitted.`] },
  {
    word: `compare`,
    wordInfo: [
      `Comparison.`,
  ...
  {
    word: `authority`,
    wordInfo: [`The power to enforce rules or give orders.`],
  },
  {
    word: `miss`,
    wordInfo: [
  ...
  { word: `act`, wordInfo: [`Something done, a deed.`, `To do something.`] },
  {
    word: `ten`,
    wordInfo: [
  ...
  { word: `little`, wordInfo: [`A small amount.`, `Small in size.`] },
  { word: `clearly`, wordInfo: [`(manner) In a clear manner.`] },
  {
    word: `discuss`,
    wordInfo: [`To converse or debate concerning a particular topic.`],
  },
  {
    word: `indeed`,
    wordInfo: [
  ...
  {
    word: `various`,
    wordInfo: [`Having a broad range (of different elements).`],
  },
  {
    word: `rather`,
    wordInfo: [`To prefer; to prefer to.`, `Prior; earlier; former.`],
  },
  {
    word: `laugh`,
    wordInfo: [
  ...
  { word: `forget`, wordInfo: [`To lose remembrance of.`] },
  {
    word: `since`,
    wordInfo: [
      `From a specified time in the past.`,
  ...
  {
    word: `enjoy`,
    wordInfo: [`To receive pleasure or satisfaction from something`],
  },
  {
    word: `network`,
    wordInfo: [
  ...
  { word: `above`, wordInfo: [`Heaven.`, `Of heaven; heavenly.`] },
  {
    word: `seat`,
    wordInfo: [
  ...
  { word: `establish`, wordInfo: [`To make stable or firm; to confirm.`] },
  {
    word: `nice`,
    wordInfo: [
      `Niceness.`,
  ...
  {
    word: `avoid`,
    wordInfo: [`To try not to meet or communicate with (a person); to shun`],
  },
  {
    word: `imagine`,
    wordInfo: [
  ...
  {
    word: `finish`,
    wordInfo: [`An end; the end of anything.`, `To complete (something).`],
  },
  {
    word: `yourself`,
    wordInfo: [`(reflexive pronoun) Your own self (singular).`],
  },
  {
    word: `talk`,
    wordInfo: [
  ...
  { word: `cultural`, wordInfo: [`Pertaining to culture.`] },
  { word: `contain`, wordInfo: [`To hold inside.`] },
  {
    word: `peace`,
    wordInfo: [
  ...
  {
    word: `camera`,
    wordInfo: [`A device for taking still or moving pictures or photographs.`],
  },
  {
    word: `structure`,
    wordInfo: [
  ...
  { word: `perform`, wordInfo: [`To do something; to execute.`] },
  {
    word: `bit`,
    wordInfo: [
  ...
  {
    word: `discover`,
    wordInfo: [`To find or learn something for the first time.`],
  },
  {
    word: `candidate`,
    wordInfo: [
  ...
  {
    word: `production`,
    wordInfo: [`The act of producing, making or creating something.`],
  },
  {
    word: `treat`,
    wordInfo: [
  ...
  {
    word: `writer`,
    wordInfo: [`A person who writes, or produces literary work.`],
  },
  {
    word: `trouble`,
    wordInfo: [
  ...
  {
    word: `institution`,
    wordInfo: [`A custom or practice of a society or community.`],
  },
  {
    word: `middle`,
    wordInfo: [`A centre, midpoint.`, `To take a middle view of.`],
  },
  { word: `sea`, wordInfo: [`A large body of salt water.`] },
  {
    word: `dream`,
    wordInfo: [
